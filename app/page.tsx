...
import { SavedHistory, defaultSavedHistory } from "@/data/OLDsavedHistory"
    ...
    <section className="px-2 md:container grid items-center gap-6 pb-8 pt-6 md:py-6 my-6 border rounded-md">
      <div className="flex flex-col items-start gap-2">
        ...
        <Alert>
          ...
          <AlertTitle>
            A knowledge graph offers a non-linear structure to information.
        ...
        <div className="text-xs pb-3">
          <p>
            ...
            <a
              href="https://twitter.com/yoheinakajima"
              target="_blank"
            ...
            .{" "}
            <a
              href="https://twitter.com/yoheinakajima/status/1706848028014068118"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://twitter.com/yoheinakajima/status/1701351068817301922"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-400"
            >
          ...
          <p>
            ...
            <a
              href="https://twitter.com/waseemhnyc"
              target="_blank"
              rel="noopener noreferrer"
              className="underline text-blue-400"
            >
            ...
            or{" "}
            <a
              href="https://tally.so#tally-open=mY0676&tally-layout=modal&tally-width=1000&tally-emoji-text=👋&tally-emoji-animation=wave&tally-auto-close=0"
              className="underline text-blue-400"
            >
              here
            </a>
